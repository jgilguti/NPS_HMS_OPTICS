...
gStyle->SetPalette(1,0);
 ...
 //
   TString inputroot;
   TString outputroot;
   inputroot=Form("ROOTfiles/OPTICS/nps_hms_optics_newfit2__%s_1_%d.root", OpticsID.Data(),FileID); 
  outputroot= Form("hist/Optics_replayednewfit2_%s_%d_fit_tree.root",OpticsID.Data(),FileID);
